...
namespace QTTabBarLib
{
  ...
  internal class QMenuItem : ToolStripMenuItem
  {
    ...
    public QMenuItem(string title, MenuGenre menuGenre) : base(title)
    {
      this.menuGenre = menuGenre;
    }
    
    public QMenuItem(string title, QTTabBarLib.MenuItemArguments mia) : base(title)
    {
      if (mia != null)
      {
        this.path = mia.Path;
    ...
    public QMenuItem(string title, MenuTarget menuTarget, MenuGenre menuGenre) : base(title)
    {
