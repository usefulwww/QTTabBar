...
namespace QTTabBarLib
{
  ...
  internal sealed class DropDownMenuDropTarget : DropDownMenuReorderable
  {
    ...
    public DropDownMenuDropTarget(IContainer container, bool respondModKeys, bool enableShiftKey, bool isRoot, IntPtr hwndDialogParent) : base(container, respondModKeys, enableShiftKey, false)
    {
      this.iDDRetval = -1;
