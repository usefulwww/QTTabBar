...
namespace QTTabBarLib
{
  ...
  internal class DropDownMenuBase : ToolStripDropDownMenu
  {
    ...
    public DropDownMenuBase(IContainer container, bool fRespondModKeys, bool fEnableShiftKey) : this(container)
    {
      this.fRespondModKeys = fRespondModKeys;
      this.fEnableShiftKey = fEnableShiftKey;
    }
    
    public DropDownMenuBase(IContainer container, bool fRespondModKeys, bool fEnableShiftKey, bool fChangeImageSelected) : this(container)
    {
      this.fRespondModKeys = fRespondModKeys;
      this.fEnableShiftKey = fEnableShiftKey;
